...
| 主角 3D / 换包 | [`features/hero-figure.md`](features/hero-figure.md) · 宇宙 `plans/beat-roguelite/figure-switch.md` | 把 Skyrim clip 重定向到 Jodi 骨名 |
| 玩法循环 | 仓 `README.md` · 宇宙 [`plans/beat-roguelite/design.md`](../../../plans/beat-roguelite/design.md)（总纲；武器/属性/局内/商店见同目录 `design-*.md`） | `plans/.../archive/` 当任务队列 |
| 架构 / DDD | [`ARCHITECTURE.md`](ARCHITECTURE.md) | — |

产品规划正文在宇宙 [`plans/beat-roguelite/`](../../../plans/beat-roguelite/)（玩法总纲 [`design.md`](../../../plans/beat-roguelite/design.md)）。
